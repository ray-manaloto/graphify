...
def watch(
    ...
    *,
    ...
    backend, fallback_backend, model, and effort are forwarded to the extract
    subprocess when set; they are only meaningful with ``semantic=True``.
    """
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default=None,
                        help="Extraction model for --semantic (passed to graphify extract)")
    parser.add_argument("--effort", default=None,
                        help="Extraction effort for --semantic (passed to graphify extract)")
